...
| PUT /customers/{id} | Update | Update customer by id | 200 (OK), 401 (Unauthorized), 403 (Forbidden) <br> 404 (Not Found) <br> 429(Too Many Requests) <br> 415 (Unsupported Media Type) <br> 500(Internal Server Error) | <br><pre lang="json">{&#13; "name": "customer1", &#13; "email": "
